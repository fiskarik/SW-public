...
ent-MobKobold = кобольд
    .desc = Кобольды, родственники Ящеров, прекрасно вписываются в свою естественную среду обитания и столь же противны, как обезьяны; готов вырвать тебе волосы и зарезать тебя до смерти.
