...
microwave-component-interact-using-transfer-success = Перенесено {$amount}.
...
microwave-menu-footer-flavor-left = Не вставляйте в костер металлические или живые предметы.
